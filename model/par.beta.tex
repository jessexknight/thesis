...
with 95\%~CI (1.43,~15) (skew normal distribution) and (1.03,~5.69) (gamma), respectively.
%===================================================================================================
...
However, approximately 40\% of the lowest activity group % TODO
reported being not sexually active during p12m \cite{SDHS2006,SHIMS2} (see \sref{model.par.wp});
