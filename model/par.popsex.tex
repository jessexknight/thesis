...
the total numbers of sex acts per modelled partnership (see \sref{foi.prior});
...
However, the proposed approach to modelling partnerships introduced in \sref{foi.prop}
