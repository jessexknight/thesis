...
I assumed that $F_{p_{4}}/12$ was 0.5--3 visits per client per month (uniform),
...
\end{equation}
I obtained mean (95\%CI): 7.0~(3.4,~12.5) for $C_{p_{4}s_{1}i_{3}}$,
yielding 10.4~(5.6,~22.1) total sex acts per month
with regular clients among lower risk FSW (prior distribution).
...
indicate fewer years selling sex versus the unadjusted proportions, which would be consistent with
...
(see \sref{app.model.math.dur} for derivation and further discussion).
...
and $F_{p_{4}} \sim \opname{Unif}(6,36)$ for regular sex work partnerships.
...
in sex work versus main/spousal and casual partnerships per \sref{app.model.math.jsam}.
%---------------------------------------------------------------------------------------------------
...
although some modest extensions can be made \cite{??}.
%---------------------------------------------------------------------------------------------------
