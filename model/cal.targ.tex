...
As discussed in \sref{model.par.wp}, I assumed that
...
and $W'$ denotes the adjusted proportions calculated in \sref{model.par.wp}.
%---------------------------------------------------------------------------------------------------
\paragraph{Age Range}
