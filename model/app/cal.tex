...
\begin{figure}[h]
  \centering\includegraphics[width=.7\linewidth]{fit.ll.base}
...
\begin{figure}[h]
  \centering\includegraphics[scale=\fitscale]{fit.prev1v2.base.all}
...
\end{figure}
\begin{figure}[h]
  \centering\includegraphics[scale=\fitscale]{fit.inc1v2.base.all}
...
\begin{figure}[h]
  \begin{minipage}[t]{.54\linewidth}
    \centering\includegraphics[scale=\fitscale]{fit.prev.anc}
