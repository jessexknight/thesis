%===================================================================================================
\subsection{Wider Population: Bias Adjustment}\label{model.par.wp}
The remaining women and men (besides FSW and clients)
are stratified by numbers of partners in the past 12 months (p12m): 0--1 and 2+.
...
This section develops and applies a new method to adjust for these potential reporting biases,
...
activity group sizes in \sref{model.par.size.wp} and
numbers of partners in \sref{model.par.pnum.msc}.
%---------------------------------------------------------------------------------------------------
\subsubsection{Reported Partner Numbers}\label{model.par.wp.data}
...
\end{figure}
%---------------------------------------------------------------------------------------------------
\subsubsection{Bias Adjustment: Rationale}
I was motivated to examine potential reporting bias because
...
%---------------------------------------------------------------------------------------------------
\subsubsection{Bias Adjustment: Approach}\label{model.par.wp.appr}
...
I defined $\varphi_{s1:0}$, $\varphi_{s2+:s1}$, and $\varphi_{u2+:u1}$ as follows
...
%---------------------------------------------------------------------------------------------------
\subsubsection{Bias Adjustment: Results}\label{model.par.wp.res}
