...
with varying notation, terminology, and organization \cite{Delva2012,Knight2022-sr}.
...
stigmatized behaviour and/or key populations \cite{UNAIDS2010size,Abdul-Quader2014}.
\par
...
or \shortquote{past 1 month}, etc. \cite{Baral2014,EswKP2014,EswSBSS2002}.
...
as population-level mixing matrices should be symmetric \cite{Knight2023-contact}.
%---------------------------------------------------------------------------------------------------
...
As discussed in \sref{model.par.turnover.act}~and~\ref{app.math.dur.xs},
...
low rates of HIV diagnosis and high rates of incidence among FSW \cite{Mountain2014a,Hakim2018};
