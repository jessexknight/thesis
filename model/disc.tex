...
(or number of concurrent partners) from survey data.
...
Despite the advancements in model parameterization described above,
...
The model structure includes $2 \times 4 \times (1 + 5 \times 5 \times 5) = 1008$ compartments in total,
...
However, the quality of model-based evidence may depend
