...
(see also \sref{foi.prior.alt} and Appendix~1 of \cite{Johnson2016a}).
...
as explored in \sref{app.math.dur.qp}.
\par
...
Similar to experiments in \sref{foi.exp.model}, \cite{Johnson2016a} first compared
...
overestimating the impact of interventions targeted at low-risk groups} \cite{Johnson2016a}.
...
(see \sref{sr.res.factors.net} and \sref{model.disc.par.part}).
Thus, I would offer to rephrase the conclusions of \cite{Johnson2016a} as:
\shortquote{without complete adjustment for `wasted contacts',
...
% TODO: verify, including adjustment durations
...
% and only sex work partnerships were considered among FSW and their clients
...
% TODO: illustrate equivalence of equations in footnote?
--- using a transformation of \eqref{eq:foi.ip} --- with $\Delta_t = 1$~year.
% Moreover, the minimum partnership change rate among sexually active risk groups is 1 pre year.
