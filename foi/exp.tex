...
\pagebreak % TEMP
%===================================================================================================
\subsection{Comparing Approaches in the Eswatini Model}\label{foi.exp.model}
...
as described below in \sref{foi.exp.model.par} and illustrated in Figure~\ref{fig:diag.foi.par}.
...
%---------------------------------------------------------------------------------------------------
\subsubsection{Equal \& Recalibrated Parameters}\label{foi.exp.model.par}
\begin{figure}
...
For \emph{recalibrated} parameters, I repeated the methods in \sref{model.cal},
...
\begin{figure}
  ...
  \floatfoot{\ffast{Anderson-Darling Test \cite{Scholz1987} for comparing distributions};
    subset of parameters with $p \le 0.1$; \ffpar; \fffoi.}
\end{figure}
%---------------------------------------------------------------------------------------------------
...
using equal parameters (top) and recalibrated parameters for comparison (bottom).
...
\end{figure}
%---------------------------------------------------------------------------------------------------
\subsubsection{Prevention Priorities using Recalibrated Parameters}\label{foi.exp.model.tpaf}
...
% TODO: (*) introduce this earlier, \eg intro.model
...
(see \sref{model.par.pdur} and Figure~\ref{fig:post.distr}).
