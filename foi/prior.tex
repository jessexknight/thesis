\section{Prior Approaches}\label{foi.prior}
...
% --- distinguished from the more generic ``contact rate'' $C_{pii'}$ from \eqref{eq:foi.strat},
...
we can show that $\lambda^\ir \ge \lambda^\ip$ (see \sref{app.math.misc.xph}).
\par
...
\begin{figure}
  ...
  {comp/Classic compartmental,pair/Pair-formation,ibm/Individual-based}{%
...
\end{figure}
\paragraph{Pair-Formation Models}
Pair-formation models were developed as early as 1988,
with the explicit motivation to overcome limitations of
classic compartmental models of STI transmission \cite{Dietz1988a}.
In pair-formation models, the fundamental population stratification
...
Pair-formation models have been applied to a variety of STIs \cite{Kretzschmar2017}.
However, the numbers of strata required to reflect all possible partnership configurations
--- including, for example, FSW with severals regular clients,
each of whom may have additional ongoing partnerships themselves ---
\emph{and} all possible health states among connected partners
--- including different HIV infection stages and treatment statuses ---
quickly become impractical \cite{Kretzschmar2017,Rao2021}.
As such, pair-formation models have seen little widespread adoption
...
allowing more complete and nuanced representations of
risk heterogeneity and partnership dynamics.
Such nuances can in fact be key determinants of epidemic dynamics and intervention impact
\cite{Hontelez2013,Johnson2016a}.
Evidently, many of the limitations of compartmental and pair-formation models
...
Although individual-based models have seen greater use than pair-formation models,
