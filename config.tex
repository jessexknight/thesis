...
\newcommand{\printchapterbibliography}[1][\clearpage]{\par#1%
...
\colorlet{url}{blu}
\definecolor{R}{HTML}{FF0033}\colorlet{rd}{R}
\definecolor{P}{HTML}{990099}\colorlet{ry}{P}
\definecolor{G}{HTML}{00CC66}\colorlet{pd}{G}
\definecolor{B}{HTML}{0066CC}\colorlet{py}{B}
\definecolor{Y}{HTML}{FF9900}\colorlet{np}{Y}
% hyperlinks
\usepackage[
  colorlinks,
  linkcolor=link,
...
\newcommand{\caslo}{\textcolor{G!33!B}{\mbox{60-40-80}}\xspace}
\newcommand{\casmd}{\textcolor{G!66!B}{\mbox{80-80-90}}\xspace}
\newcommand{\cashi}{\textcolor{G!99!B}{\mbox{95-95-95}}\xspace}
